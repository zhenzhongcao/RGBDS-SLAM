...
public:
          ...
          mT(T)
    {
        ...
        std::get<2>(mvAssociatedMapPoints).reserve(length);
    }
...
public:
    ...
    void addMapPoint(MapPoint* pMP)
    {
        ...
        std::get<2>(mvAssociatedMapPoints).emplace_back(semantic.x());
        std::get<2>(mvAssociatedMapPoints).emplace_back(semantic.y());
        std::get<2>(mvAssociatedMapPoints).emplace_back(semantic.z());
    }

    std::tuple<std::vector<float/*pos*/>, std::vector<float/*color*/>, std::vector<float/*color*/>>&
