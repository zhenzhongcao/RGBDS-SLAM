...
int CudaRasterizer::Rasterizer::forward(
	...
	const float* semantic_colors_precomp,
	...
	int* radii)
{
	...
	const float* semantic_feature_ptr = semantic_colors_precomp != nullptr ? semantic_colors_precomp : geomState.rgb;
	FORWARD::render(
		tile_grid, block,
		imgState.ranges,
	...
	float* dL_dsem)
{
	...
	const float* semantic_ptr = (semantic_colors_precomp != nullptr) ? semantic_colors_precomp : geomState.rgb;
