...
int main(int argc, char **argv)
{
    ...
    // for(int i = 0; i < vstrImageFilenamesD.size(); i++)
    // {
    //     std::cout<<vstrImageFilenamesRGB[i]<<std::endl;
    //     std::cout<<vstrImageFilenamesD[i]<<std::endl;
    // }
    ...
    for (int ni = 0; ni < nImages; ni++)
    {
        ...
        cv::cvtColor(imS, imS, CV_BGR2RGB);
        double tframe = ni;
...
//                 std::vector<std::string> &vstrImageFilenamesD)
// {
//     std::filesystem::path pathColorImageDir(strImageDir + "/color");
