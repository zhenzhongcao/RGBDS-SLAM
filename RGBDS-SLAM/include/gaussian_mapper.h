...
protected:
    ...
    void recordKeyframeRenderedRGBDepth(
        ...
        std::filesystem::path result_loss_dir,
        std::string name_suffix = "");
     void recordKeyframeRenderedRGBDepthSemantic(
        torch::Tensor &rendered,
        torch::Tensor &ground_truth,
        torch::Tensor &rendered_depth,
        torch::Tensor &ground_truth_depth,
    ...
    void renderAndRecordKeyframeRGBDepth(
        ...
        std::filesystem::path result_loss_dir,
        std::string name_suffix = "");
    void renderAndRecordKeyframeRGBDepthSemantic(
        std::shared_ptr<GaussianKeyframe> pkf,
        float &dssim,
        float &psnr,
        float &psnr_gs,
    ...
    void saveSemanticPly(std::filesystem::path result_dir);
...
protected:
    ...
    torch::Tensor depth_cache_semantics_;
