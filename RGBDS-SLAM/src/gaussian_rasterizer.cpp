...
GaussianRasterizerFunction::forward(
    ...
    torch::Tensor semantic_colors_precomp,
    ...
    // bool prefiltered)
{
    ...
    auto semantic = std::get<7>(rasterization_result);
    ...
    return {color, radii, depth, semantic};
}
    ...
    torch::autograd::tensor_list grad_outputs)
{
    ...
    auto semantic_colors_precomp = saved[5];
    ...
    auto grad_out_semantic = grad_outputs[3];
    ...
    return {
        ...
        std::get<8>(rasterization_backward_result)/*dL_dsemantics*/,
...

{
    ...
    if (!has_colors_precomp){
        ...
        semantic_colors_precomp = torch::tensor({}, options.device(torch::kCUDA));
    }
    if (!has_scales)
    ...
    return std::make_tuple(result[0]/*color*/, result[1]/*radii*/, result[2]/*depth*/, result[3]/*semantic*/);
}