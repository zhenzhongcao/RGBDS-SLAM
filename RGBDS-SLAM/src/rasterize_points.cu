...
RasterizeGaussiansCUDA(
	...
	const torch::Tensor& semantic_colors,
	...
	const bool prefiltered)
{
  ...
  if(P != 0)
  {
	  ...
	  rendered = CudaRasterizer::Rasterizer::forward(
		...
		semantic_colors.contiguous().data_ptr<float>(),
  ...
  return std::make_tuple(rendered, out_color, radii, geomBuffer, binningBuffer, imgBuffer, out_depth, out_semantic);
}
